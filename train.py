...
all_features.drop(['Utilities'], axis=1)
...
all_features['OverallQual_TotRmsAbvGrd']=all_features['OverallQual']*all_features['TotRmsAbvGrd']
all_features['GarageArea_YearBuilt']=all_features['GarageArea']*all_features['YearBuilt']
# 若无法获得测试数据，则可根据训练数据计算均值和标准差
numeric_features = all_features.dtypes[all_features.dtypes != 'object'].index

skewed_data = all_features[numeric_features].apply(lambda x: skew(x.dropna())).sort_values(ascending=False)
...
k, num_epochs, lr, weight_decay, batch_size = 5, 500, 0.001, 0.001, 64
